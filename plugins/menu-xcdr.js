...
`
await conn.sendButtonVid(m.chat, giflogo, caption, 'Nih.mp4', 'Back', '.menulist', m)
            }
...
switch (template) {
case 'codenhentai':
            let json = await fetch('https://splendid-pantsuit-hare.cyclic.app/api/anime/codenhentai?code=' + one + '&apikey=Lann')
	...
	return conn.sendListM(m.chat, aan_, aa_, m)
            ...
            case 'neko':
            case 'waifu':
        let bb = 'https://splendid-pantsuit-hare.cyclic.app/api/anime/' + args[0] + '?apikey=Lann'
...
conn.sendButton(m.chat, bbi, author, bb, [['Menu', '/menu']], m, adReply)
  ...
  if (/webp/g.test(b__d)) d__d = await webp2png(c__d)
        ...
        let cc = 'https://splendid-pantsuit-hare.cyclic.app/api/convert/' + args[0] + '?url=' + d__d + '&apikey=Lann'
        conn.sendButtonImg(m.chat, cc, author, 'Nih.jpg', 'To Sticker', '.s', m)
            break
...
case 'warface':
case 'water':
        let dd = 'https://splendid-pantsuit-hare.cyclic.app/api/ephoto/' + args[0] + '?text=' + one + '&apikey=Lann'
        conn.sendButtonImg(m.chat, dd, author, 'Nih.jpg', 'To Sticker', '.s', m)
            break
            case 'ssweb':
            let ssw = 'https://splendid-pantsuit-hare.cyclic.app/api/maker/' + args[0] + '?url=' + one + '&apikey=Lann'
        conn.sendButtonImg(m.chat, ssw, author, 'Nih.jpg', 'To Sticker', '.s', m)
            break
            case 'affect':
case 'approved':
case 'badut2':
...
let a__c = m.quoted ? m.quoted : m
  ...
  if (/webp/g.test(b__c)) d__c = await webp2png(c__c)
        ...
        let ee = 'https://splendid-pantsuit-hare.cyclic.app/api/maker/' + args[0] + '?url=' + d__c + '&apikey=Lann'
        conn.sendButtonImg(m.chat, ee, author, 'Nih.jpg', 'To Sticker', '.s', m)
            break
...
case 'streetsign':
case 'waterwriting':
        let ff = 'https://splendid-pantsuit-hare.cyclic.app/api/photofunia/' + args[0] + '?text=' + one + '&apikey=Lann'
        conn.sendButtonImg(m.chat, ff, author, 'Nih.jpg', 'To Sticker', '.s', m)
            break
...
let a__b = m.quoted ? m.quoted : m
  ...
  if (/webp/g.test(b__b)) d__b = await webp2png(c__b)
        ...
        let gg = 'https://splendid-pantsuit-hare.cyclic.app/api/photofunia/' + args[0] + '?url=' + d__b + '&apikey=Lann'
        conn.sendButtonImg(m.chat, gg, author, 'Nih.jpg', 'To Sticker', '.s', m)
            break
...
let a__a = m.quoted ? m.quoted : m
  ...
  if (/webp/g.test(b__a)) d__a = await webp2png(c__a)
        ...
        let hh = 'https://splendid-pantsuit-hare.cyclic.app/api/photooxy/' + args[0] + '?url=' + d__a + '&apikey=Lann'
        conn.sendButtonImg(m.chat, hh, author, 'Nih.jpg', 'To Sticker', '.s', m)
            break
...
case 'shadow':
case 'smoke':
        let ii = 'https://splendid-pantsuit-hare.cyclic.app/api/photooxy/' + args[0] + '?text=' + one + '&apikey=Lann'
        conn.sendButtonImg(m.chat, ii, author, 'Nih.jpg', 'To Sticker', '.s', m)
            break
...
case 'transformer':
case 'videogame':
        let jj = 'https://splendid-pantsuit-hare.cyclic.app/api/textpro/' + args[0] + '?text=' + one + '&apikey=Lann'
        conn.sendButtonImg(m.chat, jj, author, 'Nih.jpg', 'To Sticker', '.s', m)
            break
}
}
} catch (e) {
...
handler.help = ['xcdr <command> <teks>']
handler.tags = ['tools'] 
handler.command = /^xcdr$/i
