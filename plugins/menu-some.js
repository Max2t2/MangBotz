...
case 'animal':
        ...
        return conn.sendButtonImg(m.chat, cc.image, cc.fact, 'Nih.jpg', 'To Sticker', '.s', m)
            break
...
case 'animu':
        ...
        return conn.sendButtonImg(m.chat, ic.link, wm, 'Nih.jpg', 'To Sticker', '.s', m)
            break
        ...
        ${kc.lyrics}
        `
            return conn.sendButtonImg(m.chat, kc.thumbnail.genius, kd, kc.link.genius, 'To Sticker', '.s', m)
            break
  ...
  if (/webp/g.test(b_)) d_ = await webp2png(c_)
        ...
        return conn.sendButtonImg(m.chat, fil, wm, 'Nih.jpg', 'Sticker', '.s', m)
            break
            case 'misc':
  ...
  if (/webp/g.test(b__)) d__ = await webp2png(c__)
        ...
        return conn.sendButtonImg(m.chat, mis, wm, 'Nih.jpg', 'Sticker', '.s', m)
            break
  ...
  if (/webp/g.test(b___)) d___ = await webp2png(c___)
        ...
        return conn.sendButtonImg(m.chat, ove, wm, 'Nih.jpg', 'Sticker', '.s', m)
            break
