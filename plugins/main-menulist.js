...
let handler = async (m, {
    ...
    let arrayMenu = ["all", "absen", "admin", "advanced", "anonymous", "audio", "Baileys", "database", "downloader", "edukasi", "fun", "group", "host", "info", "internet", "jadian", "jadibot", "kerang", "main", "maker", "music", "nocategory", "nsfw", "nulis", "owner", "premium", "quotes", "random", "sticker", "tools", "vote", "xp", "virus"]
...
`
        ...
        if (pilih == "ke2") {
            ...
            await conn.send2ButtonLoc(m.chat, knimg, text.trim(), author, emojis + " All Menu", _p + "allmenu", emojis + " List Menu", _p + "menulist", m)

        }

        if (pilih == "ke3") {

            await conn.send2ButtonVid(m.chat, knimg, text.trim(), author, emojis + " All Menu", _p + "allmenu", emojis + " List Menu", _p + "menulist", m)

        }

        if (pilih == "ke4") {

            await conn.sendTemplateButtonLoc(m.chat, knimg, text.trim(), author, emojis + " List Menu", _p + "menulist", m)
        ...
        if (pilih == "ke6") {
            ...
            await conn.send2ButtonDoc(m.chat, text.trim(), author, emojis + " All Menu", _p + "allmenu", emojis + " List Menu", _p + "menulist", m)
