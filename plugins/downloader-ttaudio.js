...
const time = moment.tz('Asia/Jakarta').format('HH')
  const ultah = new Date('Februari 24 2023 00:00:01')
        ...
        contextInfo: {
            externalAdReply: {
                mediaUrl: '',
                        ...
                        thumbnail: await (await fetch(`https://telegra.ph/file/8047b7dfc9cee4c4f98b5.jpg`)).buffer(),
                        sourceUrl: 'https://chat.whatsapp.com/H9TCBJM85XwFgU8baLwl5U'
            }
        }
    })
}
