...
const configuration = new Configuration({ organization: 'isi punya kalian', apiKey: 'isi punya kalian' }); //KEY-OPENAI-APIKEY-KAMU = https://platform.openai.com/account/api-keys , KEY-ORG-KAMU = https://platform.openai.com/account/org-settings
